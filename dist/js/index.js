...
var getStars = function getStars(n) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      stars.push("<img class=\"cart__rating-star\" src=\"img/star.svg\" alt=\"\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ".concat(n, " \u0438\u0437 5\">"));
    } else if (i < n) {
...
var bookBlock = document.querySelector('.book__block'); //lheujt

var renderBook_getStars = function getStars(n) {
  var stars = [];

  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      stars.push("<img class=\"book__rating-star\" src=\"img/star.svg\" alt=\"\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ".concat(n, " \u0438\u0437 5\">"));
    } else if (i < n) {
...
var renderBook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(id) {
    var _yield$Promise$all, _yield$Promise$all2, book, labels, item;
...
var btnsBack = document.querySelector('.book__btn_back');
...
btnsBack.addEventListener('click', function () {
  router.navigate('/');
});
...
;// CONCATENATED MODULE: ./src/js/modules/controlFields.js
